export const language = {
	en: {
		...
		close: `Close`,
		confirmed: `Confirmed`,
		confirmPaidUpload: `Confirm Paid Upload`,
		...
		folderUploadsDisabled: `Folder uploads are temporarily disabled`,
		friday: `Friday`,
		fridayShort: `Fr`,
		from: `From`,
		...
		paid: `Paid`,
		paidUploadInfo: (fileName: string) =>
			`${fileName} exceeds your sponsored recharging units. The paid route transfers AO from your wallet to the node ledger, then uploads.`,
		pay: `Pay`,
		...
		rate: `Rate`,
		read: `Read`,
		rechargingUnits: `Recharging Units`,
		readLog: `Read Log`,
		...
		source: `Source`,
		sponsored: `Sponsored`,
		sponsoredBucketExhausted: `Sponsored bucket exhausted`,
		...
		transactionsLoading: `Getting transactions`,
		...
		uploadDropInfo: `Drag and drop files`,
