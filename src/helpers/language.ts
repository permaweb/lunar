export const language = {
	en: {
		...
		queryTimes: `Query times`,
		graphqlSource: `GraphQL Source`,
		graphqlSourceArLmdb: `AR LMDB`,
		graphqlSourceRemote: `Remote`,
		graphqlSourceDescription: `Default source for app queries and new playground tabs. Existing playground gateway selections are unchanged.`,
		queryTimeHistory: `Query time history`,
		queryTimeLast: `Last query time`,
		queryTimeHistoryInfo: `Query execution times for this playground session, newest first. Includes initialization and data fetching; excludes response rendering.`,
		queryTimeHistoryEmpty: `Run a query to see its execution time here.`,
		queryTimeRun: (run: number) => `Run #${run}`,
		queryTimeUnnamed: `Unnamed query`,
		queryTimeFailed: `Failed`,
		queryTimeCancelled: `Cancelled`,
		read: `Read`,
		readLog: `Read Log`,
